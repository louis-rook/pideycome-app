...
// IMPORTACIONES
// ============================================================================
import { recuperarPassword } from "@/actions/auth"; // Lógica de envío de email mágico
...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Mostramos mensaje de error o de éxito (confirmación de envío)
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        ...
        {/* Feedback Dinámico (Rojo para error, Verde para éxito) */}
        {msg && (
          <div className={`p-3 text-sm rounded mb-4 ${msg.includes("Error") ? "bg-red-50 text-red-600" : "bg-green-50 text-green-600"}`}>
            {msg}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
             <div className="relative">
                ...
                <input 
                  ...
                  type="email" 
                  required 
                  className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl outline-none focus:ring-2 focus:ring-[#ff6d22]" 
