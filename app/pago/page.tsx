...
import { buscarClientePorTelefono } from '@/lib/api/customers';
import { crearPedido } from '@/actions/orders';
...
export default function CheckoutPage() {
  ...
  const handlePedido = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Validación condicional para Factura
      if (requiereFactura) {
        ...
        <form onSubmit={handlePedido} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              ...
              {/* --- DOCUMENTOS (Siempre visibles, obligatorios si check activo) --- */}
              ...
              {/* Checkbox Factura (Ahora solo funciona como bandera) */}
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div 
                    ...
                    className={`cursor-pointer border-2 rounded-xl p-4 flex flex-col items-center justify-center gap-2 transition-all hover:shadow-md ${
                      metodoPago === 'efectivo' ? 'border-[#ff6d22] bg-orange-50' : 'border-gray-100 hover:border-gray-200'
                    }`}
                  >
                  ...
                  <div 
                    ...
                    className={`cursor-pointer border-2 rounded-xl p-4 flex flex-col items-center justify-center gap-2 transition-all hover:shadow-md ${
                      metodoPago === 'datafono' ? 'border-[#ff6d22] bg-orange-50' : 'border-gray-100 hover:border-gray-200'
                    }`}
                  >
                  ...
                  <div 
                    ...
                    className={`cursor-pointer border-2 rounded-xl p-4 flex flex-col items-center justify-center gap-2 transition-all hover:shadow-md sm:col-span-2 ${
                      metodoPago === 'transferencia' ? 'border-[#ff6d22] bg-orange-50' : 'border-gray-100 hover:border-gray-200'
                    }`}
                  >
